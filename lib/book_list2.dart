...
class BookList2 extends StatefulWidget {
  ...
  String uri = 'http://humanbook.kr/api/book/list';
  BookList2({required this.uri});

  @override
  _BookListState createState() => _BookListState();
}

class _BookListState extends State<BookList2> {
  ...
  @override
  void didUpdateWidget(BookList2 oldWidget) {
