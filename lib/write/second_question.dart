...
class _SecondQuestionScreenState extends State<SecondQuestionScreen> {
  ...
  final String _question = '나를 빛나게 하는 것은?';
  final String _loadEndpoint = 'http://humanbook.kr/api/manuscripts/user/2'; // step을 2로 가정
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('두 번째 질문', style: TextStyle(color: Colors.white)),
      ),
